...
function jovti(){
    ...
    var tatari1 = new PIXI.Sprite(PIXI.Texture.fromImage('tatari.png'));
    ...
    var tatari2 = new PIXI.Sprite(PIXI.Texture.fromImage('tatari.png'));
    ...
    var polyaki = new PIXI.Sprite(PIXI.Texture.fromImage('polish-infantry.png'));
    polyaki.anchor.set(0.5, 0.5);
    polyaki.scale.set(0.4, 0.4);
    polyaki.rotation -= 0.45 + Math.PI;
    polyaki.alpha = 0;
    polyaki.position.set(202,381);
    ...
    function turn6(){
        switch(step){
            case 1:
                polyaki.alpha = lerp(new PIXI.Point(polyaki.alpha, 0), new PIXI.Point(1, 0), 0.03).x;
                if(polyaki.alpha > 0.95){
                    step++;
                }
                break;
            case 2:
                if (linearNormal(polyaki.position, new PIXI.Point(220, 400), polyaki, true)){
                    step++;
                }
                break;
            case 3:
                if (linearNormal(tatari2.position, new PIXI.Point(245, 400), tatari2, true)){
                    step++;
                }
                break;
            case 4:
                MEGA_GLOBAL_VAR_SPEED = 75;
                if (linearNormal(tatari2.position, new PIXI.Point(225, 400), tatari2, true)){
                    tatari2.rotation -= Math.PI;
                    step++;
                }
                break;
            ...
            case 6:
                MEGA_GLOBAL_VAR_SPEED = 50;
                polyaki.alpha = lerp(new PIXI.Point(polyaki.alpha, 0), new PIXI.Point(0, 0), 0.03).x;
                if(polyaki.alpha < 0.03){
                    polyaki.alpha = 0;
                    step++;
                    polyaki = false;
                    tatari2 = false;
                }
                tatari2.alpha = polyaki.alpha;
                break;
            default:
                turn++;
                step = 1;
    ...
    function turn8(){
        switch(step){
            case 1:
                if (linearNormal(tatari.position, new PIXI.Point(275, 275), tatari)){
                    step++;
                }
                break;
            case 2:
                if(tatari.rotation < 0.7){
                ...
                break;
            case 3:
                linearNormal(potockij.position, new PIXI.Point(390, 125), potockij);
                linearNormal(hmel.position, new PIXI.Point(328, 153), hmel);
                if (linearNormal(tatari.position, new PIXI.Point(443, 180), tatari)){
                    tatari1.position.x = tatari.position.x;
                    tatari1.position.y = tatari.position.y;
                    step++;
                }
                break;
            case 4:
                if (linearNormal(potockij.position, new PIXI.Point(390, 125), potockij) & 
                    ...
                    tatari1.alpha = lerp(new PIXI.Point(tatari1.alpha, 0), new PIXI.Point(1, 0), 0.03).x;
                    if(tatari1.alpha > 0.95){
                        tatari1.alpha = 1;
                    }
                }
